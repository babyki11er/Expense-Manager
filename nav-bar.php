...
<nav>
    <div class="m-3 ms-2 mb-lg-1">
        ...
        <a href="balance.php" class=" btn btn-success btn-sm">Balance</a>
        ...
        <a href="records.php" class=" btn btn-sm btn-dark">Records</a>
        <a href="records.php" class=" btn btn-sm btn-dark"><?= $display ?> Kyats Left</a>
    </div>
</nav>